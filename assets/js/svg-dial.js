...
(function(factory) {
  ...
  exports.SVGDial = function(el, options) {
    ...
    console.log(document.getElementById(el.substring(1)).offsetWidth  );
    this.el = el;
    this.options = defaults(options || {}, {
      disabled: false,
      frameSize: document.getElementById(el.substring(1)).offsetWidth,
      ringWidth: 50,
  ...
  exports.SVGDial.prototype = {
    ...
    buildCanvas: function() {
      var el;
      var svgHtml = '<svg width="100%" height="auto" version="1.1" viewBox="0 0 320 320" preserveAspectRatio="xMinYMin meet")></svg>';
